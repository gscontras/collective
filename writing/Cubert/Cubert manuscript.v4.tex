...
\begin{abstract}
%% Text of abstract
\ndg{needs another pass}
Plural predication (e.g.~``the boxes are heavy'') is very common in everyday language, but is ambiguous between distributive and collective interpretations (the boxes each are heavy vs.~the boxes together are heavy).
This paper investigates the role of context in the disambiguation of plural predications.  
...
Using this method, we analyze naturally occurring plural predications. We find a role of context, but no evidence of a distinct class of predicates that resists collective interpretation.
We further explore the role of context in a final experiment, showing that both the predictability of properties and the knowledgability of the speaker affect disambiguation.
...
Of course with so many fit parameters we would not want to claim that the model uniquely, quantitatively predicts the data: future work will need to experimentally measure the appropriate noise values and do parametric manipulations of the conditions.
