...
\begin{figure}[h]
	...
	\vspace{5pt}
	\caption{Fitted model predictions and human data from Expt.~2 for collective interpretations of \emph{big} and \emph{tall}; variability of context (i.e., ``random'' vs.~``regular'') is modeled by noise of interpretation (``low'' vs.~``mid'').} \label{bigtallmodel}
\end{figure}
