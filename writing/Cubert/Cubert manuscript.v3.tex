...
Listeners know this, hence collective interpretations will become more likely as contextual predictability of the collective property----that is, the retrievability of the intended message---increases.
...
\ndg{i wonder whether it's worth explicitly tying this to subjectivity?}
\ndg{we haven't define contextual predictability very clearly. i expect reviewers to be bothered by that...}
