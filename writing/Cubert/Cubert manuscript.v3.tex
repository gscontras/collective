...
Put simply, listeners reason about likely interpretations of ambiguous plural predications given their intuitive understanding of speakers and their prior knowledge of the world (i.e., which states and interpretations are \emph{a priori} likely).
...
We present the simpler model here for illustrative purposes only. All of the model predictions we report are robust to a broad range of parameter settings, including a prior over individual objects that includes more than two possible values. In fact, including more types possible objects serves merely to increase potential speaker uncertainty and thus enhance the effect of speaker knowledge. The full model is viewable online at \url{http://forestdb.org/models/plural-predication.html}.}
...
The qualitative predictions of our plural predication model match the hypotheses and experimental results that motivated the model. Most striking is the monotonic increase in probability of collective interpretations as collective noise decreases. %As contextual noise decreases, collective properties become more predictable, and collective interpretations become more likely. 
