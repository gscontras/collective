...
$$P_{S_{1}} (u|o,v,\theta_d,\theta_c) \propto \textrm{exp}(\alpha \mathbb{E}_{P(s|o)}[U_{S_{1}} (u;s,v,\theta_d,\theta_c)])$$
...
\ndg{i think we should commit to the full/sum access here....}
...
\ndg{needs to represent uncertainty about speakers observation}
$$P_{L_{1}}(s,v|u,a) \propto P_{S_{1}}(u|o,v,\theta_d,\theta_c) \cdot P(s) \cdot P(v)$$
