...
function make_slides(f) {
  ...
  slides.multi_slider = slide({
    ...
    present_handle : function(stim) {
      ...
      $(".name_meant").html("Is this what " + name + " means?");

      this.tense = _.sample(["past","present"]);

      if (this.tense=="past") {
        $(".test_sentence").html("<font size='5'>\"The "+ stim.noun + " were "  + stim.pred + ".\"</font>");
        ...
        $(".test_sentence").html("<font size='5'>\"The "+ stim.noun + " are "  + stim.pred + ".\"</font>");

        this.sentence_types = _.shuffle(["coll","dist"]);
        var sentences = {
          "coll": "The "+ stim.noun  + " together are "+stim.pred+".",
          "dist": "The "+ stim.noun  + " each are "+stim.pred+".",        
        }
      };
