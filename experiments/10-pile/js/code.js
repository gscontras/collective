...
function make_slides(f) {
      ...
      present : function() {
          if (exp.scenario == "move") {
                    return _.shuffle([
                      ...
                      '<img src="expt-files/images/context1.3'+exp.contexts[exp.context][0]+'.png" class="context_image" alt="Step 3" id="context1.3"></img>'],
                      ['<img src="expt-files/images/context2.1.png" class="context_image" alt="Step 1" id="context2.1"></img>',
                      '<img src="expt-files/images/contextX.2.png" class="context_image" alt="Step 2" id="context1.2"></img>',
                      '<img src="expt-files/images/context2.3'+exp.contexts[exp.context][1]+'.png" class="context_image" alt="Step 3" id="context2.3"></img>'],
                      ['<img src="expt-files/images/context3.1.png" class="context_image" alt="Step 1" id="context3.1"></img>',
                      '<img src="expt-files/images/contextX.2.png" class="context_image" alt="Step 2" id="context1.2"></img>',
                      '<img src="expt-files/images/context3.3'+exp.contexts[exp.context][2]+'.png" class="context_image" alt="Step 3" id="context3.3"></img>'],
                      ['<img src="expt-files/images/context4.1.png" class="context_image" alt="Step 1" id="context4.1"></img>',
                      '<img src="expt-files/images/contextX.2.png" class="context_image" alt="Step 2" id="context1.2"></img>',
                      '<img src="expt-files/images/context4.3'+exp.contexts[exp.context][3]+'.png" class="context_image" alt="Step 3" id="context4.3"></img>']
                      ])
                  }
          else {
                    return _.shuffle([
                      ...
                      '<img src="expt-files/images/context1.3'+exp.contexts[exp.context][0]+'.nodolly.png" class="context_image" alt="Step 3" id="context1.3"></img>'],
                      ['<img src="expt-files/images/context2.1.nodolly.png" class="context_image" alt="Step 1" id="context2.1"></img>',
                      '<img src="expt-files/images/contextX.2.nodolly.png" class="context_image" alt="Step 2" id="context1.2"></img>',
                      '<img src="expt-files/images/context2.3'+exp.contexts[exp.context][1]+'.nodolly.png" class="context_image" alt="Step 3" id="context2.3"></img>'],
                      ['<img src="expt-files/images/context3.1.nodolly.png" class="context_image" alt="Step 1" id="context3.1"></img>',
                      '<img src="expt-files/images/contextX.2.nodolly.png" class="context_image" alt="Step 2" id="context1.2"></img>',
                      '<img src="expt-files/images/context3.3'+exp.contexts[exp.context][2]+'.nodolly.png" class="context_image" alt="Step 3" id="context3.3"></img>'],
                      ['<img src="expt-files/images/context4.1.nodolly.png" class="context_image" alt="Step 1" id="context4.1"></img>',
                      '<img src="expt-files/images/contextX.2.nodolly.png" class="context_image" alt="Step 2" id="context1.2"></img>',
                      '<img src="expt-files/images/context4.3'+exp.contexts[exp.context][3]+'.nodolly.png" class="context_image" alt="Step 3" id="context4.3"></img>']
                      ])
                  }
                }(),
  ...
  slides.multi_slider = slide({
    ...
    present_handle : function(stim) {
      ...
      if (exp.atomizer == "pile") {
        atomizer = "pile of boxes was ";
      }
      else {
        atomizer = "boxes were ";
      }

      $(".test_sentence").html("\"The " + atomizer + stim + "!\"");
...
function init() {
  exp.trials = [];
  exp.catch_trials = [];
  exp.atomizer = _.sample(["boxes","pile"]);
  exp.scenario = _.sample(["move","inspect"]);
  // exp.scenario = _.sample(["move"]);
  exp.context = _.sample(["0reg","1reg","2reg","3reg","4reg"]); //can randomize between subject conditions here
  // exp.context = _.sample(["4reg"]); //can randomize between subject conditions here
  exp.contexts = {"0reg": ["","","",""], 
                  "1reg": ["reg","","",""],
                  "2reg": ["reg","reg","",""],
                  "3reg": ["reg","reg","reg",""],
                  "4reg": ["reg","reg","reg","reg"]}
