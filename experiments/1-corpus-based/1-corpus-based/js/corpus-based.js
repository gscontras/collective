...
function make_slides(f) {
  ...
  slides.multi_slider = slide({
    ...
    present_handle : function(stim) {
      ...
      var name = names_list[1].Name;

      $(".name_said").html(name + " said:");

      $(".name_meant").html("Is this what " + name + " meant?");

      $(".test_sentence").html("<font size='5'>\"The "+ stim.noun_data.noun + " were "  + stim.Predicate + ".\"</font>");

      this.sentence_types = _.shuffle(["coll","dist"]);
      var sentences = {
        "coll": "The "+ stim.noun_data.noun  + " together were "+stim.Predicate+".",
        "dist": "The "+ stim.noun_data.noun  + " each were "+stim.Predicate+".",
      };
    ...
    log_responses : function() {
      for (var i=0; i<this.sentence_types.length; i++) {
        ...
        exp.data_trials.push({
          ...
          "noun" : this.stim.noun_data.noun,
          "predicate" : this.stim.Predicate,
          "animacy" : this.stim.noun_data.animacy,
