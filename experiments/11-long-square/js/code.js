      ...
      present : function() {
          if (exp.context == "random") {
                    ...
                    return _.shuffle([
                      ['<img src="expt-files/images/context1.1.png" class="context_image" alt="Step 1" id="context1.1"></img>',
                      '<img src="expt-files/images/contextX.2.png" class="context_image" alt="Step 2" id="context1.2"></img>',
                      '<img src="expt-files/images/context1.3'+exp.predicates[exp.predicate]+'.reg.png" class="context_image" alt="Step 3" id="context1.3"></img>'],
                      ['<img src="expt-files/images/context2.1.png" class="context_image" alt="Step 1" id="context2.1"></img>',
                      '<img src="expt-files/images/contextX.2.png" class="context_image" alt="Step 2" id="context1.2"></img>',
                      '<img src="expt-files/images/context2.3'+exp.predicates[exp.predicate]+'.reg.png" class="context_image" alt="Step 3" id="context2.3"></img>'],
                      ['<img src="expt-files/images/context3.1.png" class="context_image" alt="Step 1" id="context3.1"></img>',
                      '<img src="expt-files/images/contextX.2.png" class="context_image" alt="Step 2" id="context1.2"></img>',
                      '<img src="expt-files/images/context3.3'+exp.predicates[exp.predicate]+'.reg.png" class="context_image" alt="Step 3" id="context3.3"></img>'],
                      ['<img src="expt-files/images/context4.1.png" class="context_image" alt="Step 1" id="context4.1"></img>',
                      '<img src="expt-files/images/contextX.2.png" class="context_image" alt="Step 2" id="context1.2"></img>',
                      '<img src="expt-files/images/context4.3'+exp.predicates[exp.predicate]+'.reg.png" class="context_image" alt="Step 3" id="context4.3"></img>']
                      ])
                  }
                }(),
